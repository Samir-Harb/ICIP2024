_base_ = [
    'mmseg::_base_/default_runtime.py', '/media/hd1/home/Shared/CTC_CVIP/Software/DeepLearning/config/ctcSeg.py',
    'mmseg::_base_/schedules/schedule_80k.py'
]

pretrained = 'https://huggingface.co/OpenGVLab/InternImage/resolve/main/mask2former_internimage_h_896_80k_cocostuff164k.pth'  # noqa
work_dir = './work_dir'
crop_size = (512, 512)
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type='CheckpointHook', by_epoch=False, interval=1000,max_keep_ckpts=1,
        save_best='mIoU'),
